  ...
  return (
    <main className="flex-1 overflow-y-auto">
      <div className="container mx-auto px-8 py-8 max-w-5xl">
        <div className="mb-8">
          ...
          {manifest.metadata.readme && (
            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-gray-700">{manifest.metadata.readme}</p>
            </div>
          )}
        </div>
        ...
        {filteredInterfaces.length > 0 && (
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Interfaces</h2>
            <div className="space-y-6">
        ...
        {filteredTypes.length > 0 && (
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Type Aliases</h2>
            <div className="space-y-6">
